# Pocket Monsters Black — Decompilation
...
Decompilation and source-reconstruction project for **Pokémon Black**.
...
The currently supplied IRBO image is a documented underdump and is retained only as identified observational evidence. Preservation-clean full-ROM matching remains a separate target.
