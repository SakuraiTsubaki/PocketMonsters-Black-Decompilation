...
Track every officially released regional, territorial, language, and revision build of Pokémon Black against the original Japanese release baseline.
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| BLACK-JP-BASE | Black | Japan | Japanese | Unknown | Unknown | Unknown | Unknown | Baseline pending verification | Pending |
