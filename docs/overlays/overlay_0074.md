...
- Overlay ID: `74`
- FAT file ID: `74`
- Load address: `0x021F54E0`
- Decompressed/RAM size: `0x220` (544 bytes)
- BSS size: `0`
- Static initializer range: `0x021F56F8..0x021F56FC`
...
The White counterpart has the same 544-byte structure and same 26 table records. Its overlay load address is `0x021F5500`, 0x20 bytes above Black. The only decompressed Black/White byte difference is the relocated table pointer literal at offset `0x0C`:
