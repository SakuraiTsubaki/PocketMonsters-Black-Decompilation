...
| --- | --- | --- | --- | --- | --- |
| Pokémon Black | TBD | TBD | TBD | Public-source survey | Build authoritative release/revision inventory before claiming byte-level identity |
...
2. Build the release/region/language/revision matrix for Pokémon Black.
